...
class FA_Q_properties(ComputationProblem):
    """
    ...
    ordering, as well as the Gelfand Kirilliov dimension, a global dimension bound, primeness,
    semi primeness and noetherianity.
