...
class GB_Fp_dp(ComputationProblem):
    """
    This computation problem represents the computation of a Groebner basis of a given polynomial system
    (commutative) with coefficients in a finite field and the degree reverse lexicographical ordering.

    .. moduleauthor:: Albert Heinle <albert.heinle@rwth-aachen.de>
    """
    __associatedTables = ["ModPS"]
    """
