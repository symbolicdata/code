...
def extractSolution(outpString):
    ...
    computation performed in Risa/Asir, using the executable code that was
    ...
    :param outpString: The String that was returned by the Risa/Asir-execution
    :type  outpString: str
